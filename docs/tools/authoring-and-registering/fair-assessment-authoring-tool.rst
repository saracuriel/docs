...
-----------------------
You can find an extended user guide with the most frequent errors and questions when registering a FAC here: , and a detailed videotutorial that will guide your through the whole process here: 
